    ...
    def atendimento(self):
        ...
        try:
            ...
            while atendimento:
                ...
                if sel == '1':
                    tipo = input ("""Qual tipo de dado deseja ler? (1- Holding Register) |2- Coil |3- Input Register |4- Discrete Input| 5- ler dados float) :""")
                    ...
                    tipo = input ("""Qual tipo de dado deseja escrever? (1- Holding Register) |2- Coil| 3- registrador float) :""")
                    addr = input (f"Digite o endereço da tabela MODBUS: ")
